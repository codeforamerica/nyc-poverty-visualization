...
export default class ProgramChart extends Component {
  constructor(props) {
    super(props);
    var defaultData = [
      {text: 'SNAP', value: 3.6, programName:'SNAP', desc: "This program is run by the New York City Human Resources Administration and provides food assistance for nearly 1.8 million New Yorkers. More information on the program and the application process is <a href='http://www.nyc.gov/html/hra/html/services/snap.shtml'>available here</a>." },
      ...
      {text: 'HEAP', value: 0.0, programName:'HEAP', desc: "This program is run by the New York City Human Resources Administration and provides food assistance for nearly 1.8 million New Yorkers. More information on the program and the application process is <a href='http://otda.ny.gov/programs/heap/'>available here</a>." },
    ];
